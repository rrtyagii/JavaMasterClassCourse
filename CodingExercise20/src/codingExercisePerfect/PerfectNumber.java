...
public class PerfectNumber {
  public static void main(String[] args) {
	  ...
	  System.out.println("is the number perfect number: "+result);
  }
  public static boolean isPerfectNumber(int number) {
	     ...
	     else { //A perfect number is a positive integer which is equal to the sum of its proper positive divisors.
	    	//Proper positive divisors are positive integers that fully divide the perfect number without leaving a remainder and exclude the perfect number itself.
	    	//For example, take the number 6:
	    	//Its proper divisors are 1, 2, and 3 (since 6 is the value of the perfect number, it is excluded), and the sum of its proper divisors is 1 + 2 + 3 = 6.
	    	 int original=number;
	    	 int divisor=0;
		    	 ...
		    	 for(int i=1; i<number; i++) {
		    		 if(number%i==0) {
		    			 divisor+=i; 
		    		       System.out.println("the new sum of divisors now is "+divisor);          }
		    	 }
		         if(divisor==original) {
		        	 return true; 
		         }
