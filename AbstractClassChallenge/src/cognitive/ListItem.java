...
public abstract class ListItem {
    ...
    protected ListItem nextItemLink=null; 
    protected ListItem previousItemLink=null;
    
    protected Object objectValue; 
    
    public ListItem(Object objValue) {
    	this.objectValue=objValue; 
    }
    
    
     abstract ListItem goingForward() ; 
     abstract ListItem setGoingForward(ListItem lisst); 
     
     abstract ListItem goingBack(); 
     abstract ListItem setGoingBack(ListItem item);
     
     
     abstract int compareItems(ListItem item);
