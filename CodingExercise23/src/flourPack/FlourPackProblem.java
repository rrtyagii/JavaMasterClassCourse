...
//
	    ...
	    public static boolean canPack(int bigCount, int smallCount, int goal) {
	    	           ...
	    	           int smallPack=smallCount ; 
	    	           int sum=bigPack+smallPack; 
	    	           
	    	           
	    	           

//  Therefore, the sum of the kilos of bigCount and smallCount must be at 
//  least equal to the value of goal. The method should return true 
...
//	return true because of 1 full bigCount bag and 4 full smallCount bags equal goal, 
