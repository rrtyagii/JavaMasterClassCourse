...
and seconds equal the minutes and seconds passed to this method and 
return that value as string in format gXXh YYm ZZsh where 
...
If it is valid, then calculate how many minutes are in the seconds value and then 
call the other overloaded method passing the correct minutes and seconds calculated 
...
Bonus: 
	...
	but it is ok if it is 1h 1m 0s (Tip: use if-else)
...
public class SecondsAndMinutesChallenge {
	...
	System.out.println(getDurationString(85, 25));
	...
	public static String getDurationString(long seconds) {
		...
		long sec=seconds%60; 
		return getDurationString(minute, sec) ; 
	}
